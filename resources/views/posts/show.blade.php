					...
					<div class="single-post info-area">
                        ...
                        <hr>
                            ...
                            <div class="row-12" style="display: flex;">
                                <div class="col-sm-6">
                                    {!! Html::linkRoute('posts.edit', 'Szerkesztés', array($post->id), array('class' => 'btn btn-primary btn-block')) !!}
                                </div>
                            

                            
                                <div class="col-sm-6">
                                    {!! Html::linkRoute('posts.destroy', 'Törlés', array($post->id), array('class' => 'btn btn-danger btn-block')) !!}
                                </div>
                            </div>
